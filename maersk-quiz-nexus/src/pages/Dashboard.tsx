...
const Dashboard = () => {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      ...
      default:
        return "bg-maersk-light-blue/20 text-maersk-blue border-maersk-blue/30";
    }
  };
    ...
    <div className="min-h-screen px-3 sm:px-4 pb-16 sm:pb-20">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-8"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6">
            {publishedQuizzes.map((quiz, index) => {
              ...
              const scorePercentage = userResult
                ? (userResult.score / userResult.total_questions) * 100
                : 0;
