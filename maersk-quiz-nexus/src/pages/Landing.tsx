  ...
  const features = [
    {
      ...
      description:
        "Instant feedback with animated results and detailed explanations",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Role-based Access",
      description:
        "Separate admin and user interfaces with advanced permissions",
    },
    {
      icon: <BarChart3 className="h-6 w-6" />,
      title: "Advanced Analytics",
      description:
        "Deep insights into performance trends and learning patterns",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Enterprise Security",
      description:
        "Bank-level security with SOC2 compliance and data encryption",
    },
    {
